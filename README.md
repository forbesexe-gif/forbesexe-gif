...
KoalaWire is an early-stage defensive security platform intended for authorized vulnerability assessment of systems, websites, configurations, dependencies, and source code. The project is being structured around explicit scope controls, reproducible findings, evidence retention, and human-reviewed remediation.
...
- B.B.A. in Finance candidate at Baruch College
- Banking operations experience involving transaction controls, KYC/AML, fraud prevention, and exception escalation
- FINRA Securities Industry Essentials exam passed
- Long-standing technical interest through game modification, Android rooting, custom ROM installation, operating-system flashing, and system recovery
